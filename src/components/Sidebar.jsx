    ...
    <div className="w-full h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-colors duration-300">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white rounded-lg transition-all duration-200 disabled:cursor-not-allowed font-medium"
        >
          <RefreshCw className={`h-4 w-4 ${isRefreshing ? 'animate-spin' : ''}`} />
          <span>
            {isRefreshing ? t('sidebar.refreshing', 'Aktualisiere...') : t('sidebar.refreshData', 'Daten aktualisieren')}
          </span>
        </button>
      </div>
